 ...
 * // BEGIN - Added by GT Silion - BEGIN //
 * {Code included or modified by GT Silicon}
 * // END - Added by GT Silion - END //
 */
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (counter < 4) {
                    ...
                    try {
                        bytes = mmInStream.read(buffer, 0, 4 - counter);
                        counter += bytes;
                    }
                    catch (IOException e) {
                        e.printStackTrace();
...
;
                ...
                {
                    try {
                        counter=mmInStream.read(buffer, 0, 64);
                    } catch (IOException e) {
                    ...
                    {
                        try {
                            counter+=mmInStream.read(buffer, counter, 64-counter);
                        } catch (IOException e) {
                            // TODO Auto-generated catch block
                            e.printStackTrace();
                        }
                    ...
                    if(counter==64)
                    {
                        mHandler.obtainMessage(Constants.MESSAGE_READ, 64, -1, buffer)
                                .sendToTarget();
                        counter=0;
                    }
